...
<body class="hold-transition sidebar-mini" style="background-image: url(img/bg.jpeg);  overflow: hidden; /* Mencegah scroll */
    ...
    <div class="wrapper">
        ...
        <nav class="navbar navbar-expand navbar-primary navbar-dark fixed-top">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" role="button"><img src="img/jti.png" alt="" width="100px"></i></a>
                </li>
            </ul>
        </nav>
    ...
    <!-- ./wrapper -->
    <div class="navbar-line" style="background-color: #ffd700; /* Warna kuning sesuai gambar */
        height: 5px;
        width: 500%;">
    </div>
    <!-- jQuery -->
